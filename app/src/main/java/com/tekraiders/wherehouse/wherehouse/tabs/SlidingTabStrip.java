...
class SlidingTabStrip extends LinearLayout {
    ...
    private SlidingTabsLayout.TabColorizer mCustomTabColorizer;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final SlidingTabsLayout.TabColorizer tabColorizer = mCustomTabColorizer != null
                ? mCustomTabColorizer
                : (SlidingTabsLayout.TabColorizer) mDefaultTabColorizer;
    ...
    private static class SimpleTabColorizer implements SlidingTabsLayout.TabColorizer {
